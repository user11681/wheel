...
//        Map.entry("terraformers", "https://maven.terraformersmc.com"),
    ...
    private static final DependencyContainer dependencies = new DependencyContainer(
        ...
        new DependencyEntry("me.sargunvohra.mcmods:autoconfig1u:latest.release").key("autoconfig").repository("jcenter"),
        new DependencyEntry("me.shedaniel.cloth:basic-math:latest.release").key("basicmath").repository("jcenter"),
